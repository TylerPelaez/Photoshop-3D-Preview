...
// This is a fork of https://github.com/Fennec-hub/three-viewport-gizmo/tree/main - This was the fastest way to resolve dupe import bug. 
...
export class ViewportGizmo extends Object3D<ViewportGizmoEventMap> {
  ...
  constructor(
    ...
    options = Object.assign(GIZMO_DEFAULT_OPTIONS, options || {}) as GizmoOptions;
